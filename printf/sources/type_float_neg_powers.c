...
/*   Updated: 2020/01/02 18:40:39 by geliz            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

void	ft_summ_divis_strings(char res[20000], char temp[20000])
{
		int		i;
		int		nbr;
		int		ost;
...
void	ft_reverse_array(char arr[20000])
{
	int		i;
	int		j;
	char	temp[20000];
...
void	ft_neg_pow_cycle(char temp[20000])
{
		int		i;
		int		ost;
		int		tmp;
...
void	ft_negative_power(char temp[20000], int pow)
{
